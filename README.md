...
Este é um trabalho acadêmico; para contribuições, siga as convenções do projeto e evite commitar o arquivo `db.sqlite`.
...
Equipe Space Genius — Projeto para UNINOVE (2º semestre de 2026)
